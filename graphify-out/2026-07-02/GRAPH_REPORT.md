...
## Corpus Check
- 41 files · ~68,965 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 486 nodes · 702 edges · 68 communities (21 shown, 47 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b54dd54f`
...
8. `AnkiCardPage v0.1 — План реализации (Android MAUI)` - 12 edges
...
## Communities (68 total, 47 thin omitted)
...
Cohesion: 0.12
Nodes (6): double, List, MediaRecorder, AnkiCardPage, TranslationProvider, TtsProvider
...
- **Why does `PlayerPage` connect `PlayerPage Audio Controls` to `Audio Engine Decoding`, `Project Context & Dependencies`, `Menu Page Navigation`, `MAUI App Entry Points`, `Waveform Drawing (SkiaSharp)`, `Logging and Recent Files`, `Launcher Icon Round XXXHDPI`, `Android Activity Lifecycle`?**
